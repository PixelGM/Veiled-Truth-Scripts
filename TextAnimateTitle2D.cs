...
public class TextAnimateTitle2D : MonoBehaviour
{
    public float animationSpeed = 0.1f;
    public string[] randomCharacters = { "!", "@", "#", "$", "%", "&", "*", "-", "+", "=" };

    private TextMeshProUGUI textMeshPro; // Change to TextMeshProUGUI
    ...
    void Start()
    {
        textMeshPro = GetComponent<TextMeshProUGUI>(); // Change to TextMeshProUGUI
